  ...
  return(
    <>
      ...
      <div className={styles.menu}>
        <Menu name="Espress" desc="Experience the bold, rich flavor of our finely crafted espresso—small in size, but big in energy!"/>
        ...
        <Menu name="Americano" desc="Bold espresso meets hot water for a smooth, robust flavor—perfect for those who love their coffee strong but easy to sip!"/>
        ...
        <Menu name="Affogato" desc="A heavenly mix of hot espresso poured over creamy vanilla ice cream. Dessert and coffee—why choose when you can have both?"/>
      ...
      <div className={styles.footer}>
          <div style={{textAlign:"center",fontSize:"50px"}}>Book your seat now!!! <button>Book</button></div><br></br><br></br><br></br>
